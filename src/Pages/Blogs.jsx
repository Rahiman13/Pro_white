        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {loading ? (
            ...
            <div className={`grid grid-cols-1 ${
              isSearching ? 'md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3' : 'md:grid-cols-2 lg:grid-cols-3'
            } gap-8`}>
              <AnimatePresence>
                  ...
                  >
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4 flex gap-2">
                        ...
                        <motion.span 
                          whileHover={{ scale: 1.05 }}
                          className="px-3 py-1 rounded-full text-sm bg-blue-500/90 text-white backdrop-blur-sm shadow-lg"
                        >
                          {blog.category}
                        </motion.span>
                      </div>
